...
#     .Call('_mygrf_compute_split_frequencies', PACKAGE = 'mygrf', forest_object, max_depth)
# }

# compute_weights <- function(forest_object, train_matrix, test_matrix, num_threads) {
#     .Call('_mygrf_compute_weights', PACKAGE = 'mygrf', forest_object, train_matrix, test_matrix, num_threads)
# }

# compute_weights_oob <- function(forest_object, train_matrix, num_threads) {
#     .Call('_mygrf_compute_weights_oob', PACKAGE = 'mygrf', forest_object, train_matrix, num_threads)
# }

# merge <- function(forest_objects) {
#     .Call('_mygrf_merge', PACKAGE = 'mygrf', forest_objects)
# }
...
#     .Call('_mygrf_causal_train', PACKAGE = 'mygrf', train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }
...
#     .Call('_mygrf_causal_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, test_matrix, num_threads, estimate_variance)
# }

# causal_predict_oob <- function(forest_object, train_matrix, outcome_index, treatment_index, num_threads, estimate_variance) {
#     .Call('_mygrf_causal_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_ll_causal_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_ll_causal_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_causal_survival_train', PACKAGE = 'mygrf', train_matrix, causal_survival_numerator_index, causal_survival_denominator_index, treatment_index, censor_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }

# causal_survival_predict <- function(forest_object, train_matrix, test_matrix, num_threads, estimate_variance) {
#     .Call('_mygrf_causal_survival_predict', PACKAGE = 'mygrf', forest_object, train_matrix, test_matrix, num_threads, estimate_variance)
# }

# causal_survival_predict_oob <- function(forest_object, train_matrix, num_threads, estimate_variance) {
#     .Call('_mygrf_causal_survival_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_instrumental_train', PACKAGE = 'mygrf', train_matrix, outcome_index, treatment_index, instrument_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, reduced_form_weight, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }
...
#     .Call('_mygrf_instrumental_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, instrument_index, test_matrix, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_instrumental_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, treatment_index, instrument_index, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_multi_causal_train', PACKAGE = 'mygrf', train_matrix, outcome_index, treatment_index, sample_weight_index, use_sample_weights, gradient_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, stabilize_splits, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }
...
#     .Call('_mygrf_multi_causal_predict', PACKAGE = 'mygrf', forest_object, train_matrix, test_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
# }

# multi_causal_predict_oob <- function(forest_object, train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance) {
#     .Call('_mygrf_multi_causal_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, num_outcomes, num_treatments, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_multi_regression_train', PACKAGE = 'mygrf', train_matrix, outcome_index, sample_weight_index, use_sample_weights, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }

# multi_regression_predict <- function(forest_object, train_matrix, test_matrix, num_outcomes, num_threads) {
#     .Call('_mygrf_multi_regression_predict', PACKAGE = 'mygrf', forest_object, train_matrix, test_matrix, num_outcomes, num_threads)
# }

# multi_regression_predict_oob <- function(forest_object, train_matrix, num_outcomes, num_threads) {
#     .Call('_mygrf_multi_regression_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, num_outcomes, num_threads)
# }
...
#     .Call('_mygrf_probability_train', PACKAGE = 'mygrf', train_matrix, outcome_index, sample_weight_index, use_sample_weights, num_classes, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }
...
#     .Call('_mygrf_probability_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, num_classes, test_matrix, num_threads, estimate_variance)
# }

# probability_predict_oob <- function(forest_object, train_matrix, outcome_index, num_classes, num_threads, estimate_variance) {
#     .Call('_mygrf_probability_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, num_classes, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_quantile_train', PACKAGE = 'mygrf', quantiles, regression_splitting, train_matrix, outcome_index, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, compute_oob_predictions, num_threads, seed)
# }

# quantile_predict <- function(forest_object, quantiles, train_matrix, outcome_index, test_matrix, num_threads) {
#     .Call('_mygrf_quantile_predict', PACKAGE = 'mygrf', forest_object, quantiles, train_matrix, outcome_index, test_matrix, num_threads)
# }

# quantile_predict_oob <- function(forest_object, quantiles, train_matrix, outcome_index, num_threads) {
#     .Call('_mygrf_quantile_predict_oob', PACKAGE = 'mygrf', forest_object, quantiles, train_matrix, outcome_index, num_threads)
# }
...
#     .Call('_mygrf_ll_regression_train', PACKAGE = 'mygrf', train_matrix, outcome_index, ll_split_lambda, ll_split_weight_penalty, ll_split_variables, ll_split_cutoff, overall_beta, mtry, num_trees, min_node_size, sample_fraction, honesty, honesty_fraction, honesty_prune_leaves, ci_group_size, alpha, imbalance_penalty, clusters, samples_per_cluster, num_threads, seed)
# }
...
#     .Call('_mygrf_ll_regression_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, test_matrix, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_ll_regression_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, ll_lambda, ll_weight_penalty, linear_correction_variables, num_threads, estimate_variance)
# }
...
#     .Call('_mygrf_survival_predict', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, test_matrix, num_threads, num_failures)
# }
...
#     .Call('_mygrf_survival_predict_oob', PACKAGE = 'mygrf', forest_object, train_matrix, outcome_index, censor_index, sample_weight_index, use_sample_weights, prediction_type, num_threads, num_failures)
# }
